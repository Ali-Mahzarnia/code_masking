...
def data_organizer_random_2d(kfold, nth_fold):
    ...
    image = nib.load('/home/alex/hsm/Invivo/RARE/data/RARE_full_120222.nii.gz')
    data_img = image.get_fdata()
    mask = nib.load('/home/alex/hsm/Invivo/RARE/data/RARE_mask_full_120222.nii.gz')
...
#              tf.keras.metrics.AUC(name='auc')
        ...
        np.save('/home/alex/hsm/Invivo/RARE/results/history_2d_contrast_full_2.npy',history.history)

        model.save('/home/alex/hsm/Invivo/RARE/results/model_2d_contrast_full_2.h5')
...
if __name__=='__main__':
    param_string = 'metrics_trial_contrast_full'
