...
imglist = os.listdir('/home/alex/hsm/Invivo/RARE/data/test_data/')

for img_num in range(0,len(imglist)):

    img_name = imglist[img_num]

    image = nib.load('/home/alex/hsm/Invivo/RARE/data/test_data/' + img_name)
    ...
    model_path = '/home/alex/hsm/Invivo/RARE/results/model_2d_fold_1_metrics_trial1_3_full.h5'
    ...
    #nib.save(nif_test, '/home/alex/Stroke_multi/results/mask_test_3d_fold_' + str(nth_fold) + '_trial1_1.nii')
        ...
        nib.save(nif_img, '/home/alex/hsm/Invivo/RARE/pred/pred_mask_' + img_name)
