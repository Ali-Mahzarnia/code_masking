...
def data_organizer_random_2d(kfold, nth_fold):
    ...
    image = nib.load('/home/alex/hsm/Invivo/data/RARE_full_071922.nii.gz')
    data_img = image.get_fdata()
    mask = nib.load('/home/alex/hsm/Invivo/data/RARE_mask_full_071922.nii.gz')
...
def cnn(fliter_num, kernel_size, kfold, nth_fold, trial_str):
    with strategy.scope():
        ...
        np.save('/home/alex/hsm/Invivo/results/history_2d_fold_' + str(nth_fold) + '_' + trial_str + '.npy',history.history)

        model.save('/home/alex/hsm/Invivo/results/model_2d_fold_' + str(nth_fold) + '_' + trial_str + '.h5')

        test_pred = model.predict(x_val)

        nif_pred = nib.Nifti1Image(test_pred, affine=np.eye(4))

        nib.save(nif_pred, '/home/alex/hsm/Invivo/results/pred_2d_fold_' + str(nth_fold) + '_' + trial_str + '.nii')


        nif_mask = nib.Nifti1Image(y_val, affine=np.eye(4))

        nib.save(nif_mask, '/home/alex/hsm/Invivo/results/mask_test_2d_fold_' + str(nth_fold) + '_' + trial_str + '.nii')
...
def calc_mean_dice(nth_fold, trial_str):
    ...
    pred_path_batch1 = '/home/alex/hsm/Invivo/results/pred_2d_fold_' + str(nth_fold+1) + '_' + trial_str + '.nii'
    mask_path_batch1 = '/home/alex/hsm/Invivo/results/mask_test_2d_fold_' + str(nth_fold+1) + '_' + trial_str + '.nii'
