...
def data_organizer_random_2d(kfold, nth_fold):
    ...
    image = nib.load('/mnt/paros_WORK/hsm/Invivo/data/RARE_full_120122.nii.gz')
    data_img = image.get_fdata()
    mask = nib.load('/mnt/paros_WORK/hsm/Invivo/data/RARE_mask_full_120122.nii.gz')
...
def cnn(fliter_num, kernel_size, kfold, nth_fold, trial_str):
    with strategy.scope():
        ...
        x_train, y_train = data_organizer_random_2d(kfold, nth_fold)
...
if __name__=='__main__':
    param_string = 'metrics_trial1_3_full'
    cnn(64,5,1,1, param_string)
